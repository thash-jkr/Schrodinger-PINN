...
# Model setup
model = PINN(layers, 0, 100).to(device)
...
torch.save(model.state_dict(), "Schrodinger-PINN/src/results/general/model_2.pth")

with open("Schrodinger-PINN/src/results/general/history_2.json", "w") as f:
    json.dump(history, f)
